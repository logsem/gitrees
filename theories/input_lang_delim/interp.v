...
Section interp.
 ...
 Qed.
  ...
  Lemma interp_expr_head_step {S : Set} (env : interp_scope S) (e : expr S) e' σ σ' K Ko n :
    head_step e σ K e' σ' K Ko (n, 0) →
  ...
  Lemma interp_expr_fill_no_reify {S} K K' Ko (env : interp_scope S) (e e' : expr S) σ σ' n :
    head_step e σ K e' σ' K' Ko (n, 0) →
    ResetK ∉ K->
