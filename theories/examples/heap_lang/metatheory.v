...
Lemma bin_op_eval_closed op v1 v2 v' :
  ...
  is_closed_val v'.
Proof.
  rewrite /bin_op_eval /bin_op_eval_lit /bin_op_eval_bool /bin_op_eval_int /bin_op_eval_loc;
...
Proof.
  ...
  - unfold un_op_eval in *. unfold un_op_eval_lit in *. repeat case_match; naive_solver.
